...
public class DashboardMenu_StepDefs {
    ...
    public void the_user_logs_in_using_following_credentials(Map<String,String> userCredantials ) {
        System.out.println("userCredantials = " + userCredantials);
        loginPage.login(userCredantials.get("username"),userCredantials.get("password"));
        Assert.assertTrue(dashboardPage.welcomeMessage.getText().contains(userCredantials.get("message")));
    }
